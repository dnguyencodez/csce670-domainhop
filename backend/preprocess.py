...
games = games.drop(['Platform', 'Year_of_Release', 'Publisher', 'NA_Sales', 'EU_Sales', 'JP_Sales', 'Other_Sales', 'Global_Sales', 'Critic_Score', 'Critic_Count', 'User_Count', 'Rating'], axis=1)
games.to_csv('cleaned_video_game_sales_and_ratings.csv', index=False)
